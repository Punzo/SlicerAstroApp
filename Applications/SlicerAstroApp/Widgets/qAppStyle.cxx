...
QPalette qAppStyle::standardPalette()const
{
  ...
  palette.setColor(QPalette::Mid, "#a8ddef");
  palette.setColor(QPalette::Dark, "#a8ddef");
  palette.setColor(QPalette::Active, QPalette::ButtonText, "#a8ddef");
  palette.setColor(QPalette::Inactive, QPalette::ButtonText, "#a8ddef");
  palette.setColor(QPalette::Disabled, QPalette::ButtonText, "#005f9e");
